...
class HTMLManager {
    ...
    showFeatures(featureType) {
        ...
        if (featureType === 'Business') {
            ...
            this.mapManager.createMap('./src/data/WardOutlines.geojson', './src/data/data.csv', './src/data/addresses_with_wards_NEW.csv', 'Business');
        ...
        if (featureType === 'Demographic') {
            ...
            if (!this.mapManager.polygonManager) {
                this.mapManager.createMap('./src/data/WardOutlines.geojson', './src/data/demographics.csv', null, 'Demographic');
            }
